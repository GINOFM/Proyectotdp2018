...
public class VictoriaState extends GameState {
	...
	public VictoriaState(GameStateManager gsm, int puntaje) {
		gameStateManager = gsm;
		this.puntaje = puntaje;
	}

	public void init() {
		ImageIcon ii = new ImageIcon("resources/menu_victoria.png");
		fondo = ii.getImage();
